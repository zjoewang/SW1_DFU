...
const char MAX17055::RCOMP0 = 0x97;
const int MAX17055::m_ADDR = (0x36 << 1);

MAX17055::MAX17055(PinName sda, PinName scl, int hz) : m_I2C(sda, scl)
{
...
bool MAX17055::open()
{
    //Probe for the MAX17055 using a Zero Length Transfer
...
void MAX17055::sleepEnabled(bool enabled)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_MODE);
...
float MAX17055::hibernateThreshold()
{
    //Read the 16-bit register value
...
void MAX17055::hibernateThreshold(float threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_HIBRT);
...
float MAX17055::activeThreshold()
{
    //Read the 16-bit register value
    unsigned short value = read(REG_HIBRT);
...
void MAX17055::activeThreshold(float threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_HIBRT);
...
void MAX17055::compensation(char rcomp)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
void MAX17055::tempCompensation(float temp)
{
...
void MAX17055::sleep(bool sleep)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
bool MAX17055::socChangeAlertEnabled()
{
    //Read the 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
void MAX17055::socChangeAlertEnabled(bool enabled)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
char MAX17055::emptyAlertThreshold()
{
    //Read the 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
void MAX17055::emptyAlertThreshold(char threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_CONFIG);
...
float MAX17055::vAlertMinThreshold()
{
    //Read the 16-bit register value
...
void MAX17055::vAlertMinThreshold(float threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_VALRT);
...
float MAX17055::vAlertMaxThreshold()
{
    //Read the 16-bit register value
    unsigned short value = read(REG_VALRT);
...
void MAX17055::vAlertMaxThreshold(float threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_VALRT);
...
float MAX17055::vResetThreshold()
{
    //Read the 16-bit register value
...
void MAX17055::vResetThreshold(float threshold)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_VRESET_ID);
...
bool MAX17055::comparatorEnabled()
{
    //Read the 16-bit register value
    unsigned short value = read(REG_VRESET_ID);
...
void MAX17055::comparatorEnabled(bool enabled)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_VRESET_ID);
...
bool MAX17055::vResetAlertEnabled()
{
    //Read the 16-bit register value
...
void MAX17055::vResetAlertEnabled(bool enabled)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_STATUS);
...
void MAX17055::clearAlertFlags(char flags)
{
    //Read the current 16-bit register value
    unsigned short value = read(REG_STATUS);
...
unsigned short MAX17055::read(char reg)
{
...
void MAX17055::write(char reg, unsigned short data)
{
    //Create a temporary buffer
    char buff[3];
